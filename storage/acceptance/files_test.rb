...
describe "Storage Files Snippets" do
  ...
  let(:secondary_bucket) do
    secondary_bucket_name = bucket.name + "_secondary"
    storage_client.create_bucket secondary_bucket_name
  end
  ...
  after(:all) do
    ...
    delete_bucket secondary_bucket.name
  end
  ...
  describe "upload_file" do
    it "uploads a file to a storage bucket" do
      assert_output /Uploaded #{remote_file_name}/ do
  ...
  describe "upload_encrypted_file" do
    it "uploads a file to a storage bucket with an encryption key" do
      ...
      assert_output /Uploaded #{remote_file_name} with encryption key/ do
        binding.pry
  ...
  describe "download_file" do
    it "downloads a file from a storage bucket" do
      ...
      assert_output /Downloaded #{remote_file_name}/ do
  ...
  describe "download_file_requester_pays" do
    it "downloads a file from a public storage bucket" do
      ...
      assert_output /Downloaded #{remote_file_name} using billing project #{storage_client.project}/ do
  ...
  describe "download_encrypted_file" do
    it "downloads an encrypted file from storage bucket" do
      ...
      assert_output /Downloaded encrypted #{remote_file_name}/ do
  ...
  describe "delete_file" do
    it "deletes a file from storage bucket" do
      ...
      assert_output /Deleted #{remote_file_name}/ do
  ...
  describe "set_metadata" do
    it "sets the metadata for a file in a storage bucket" do
      ...
      assert_output /Metadata for #{remote_file_name} has been updated./ do
  ...
  describe "make_file_public" do
    it "makes a file from a storage bucket publicly accessible from a url" do
      bucket.create_file local_file, remote_file_name
      refute_nil bucket.file remote_file_name
      response = HTTParty.get bucket.file(remote_file_name).public_url
      refute response.ok?

      assert_output /#{remote_file_name} is publicly accessible at #{ bucket.file(remote_file_name).public_url}/ do
  ...
  describe "rename_file" do
    it "renames a file in a storage bucket" do
      ...
      assert_output /#{remote_file_name} has been renamed to #{new_name}/ do
  ...
  describe "copy_file" do
    it "copies a file from one storage bucket to another" do
      ...
      assert_output /#{remote_file_name} in #{bucket.name} copied to #{remote_file_name} in #{secondary_bucket.name}/ do
  ...
  describe "rotate_encryption_key" do
    it "changes the encryption key used for a file in a storage bucket" do
      ...
      assert_output /The encryption key for #{remote_file_name} in #{bucket.name} was rotated./ do
  ...
  describe "generate_signed_url" do
    it "generates a signed url for a file in a bucket" do
      ...
      assert response.ok?
      assert_equal response.body, File.read(local_file)
    end
  end
